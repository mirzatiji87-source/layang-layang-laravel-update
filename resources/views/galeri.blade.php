@extends('layouts.app')
@section('title', 'Galeri Desain - LayangFest 2026')
@section('content')

@push('styles')
<style>
    .page-hero {min-height:55vh;
    background:linear-gradient(135deg,#0f0f23,#1a1a3e,#1e3a5f);
    display:flex;
    align-items:center;
    ...
    .gallery-section { max-width:1280px; margin:0 auto; padding:80px 32px; background: #f8fafc;}
...
<div class="page-hero">
    ...
    <div style="text-align:center;position:relative;z-index:2;max-width:900px"></div>
        ...
        <p style="font-size:16px;color:rgba(255,255,255,.55)">Koleksi desain layang-layang terbaik peserta LayangFest 2026</p>
    </div>
</div>
